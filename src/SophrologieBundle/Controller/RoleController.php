...
use SophrologieBundle\Entity\Role;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('SophrologieBundle:Role')->findAll();
    ...
    {
        $role = new Role();
        $form = $this->createForm('SophrologieBundle\Form\RoleType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('SophrologieBundle\Form\RoleType', $role);
